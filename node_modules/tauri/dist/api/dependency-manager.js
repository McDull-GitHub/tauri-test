...
/***/ "./src/api/dependency-manager/cargo-commands.ts":
/*!******************************************************!*\
  !*** ./src/api/dependency-manager/cargo-commands.ts ***!
  \******************************************************/
...
var log = logger_1.default('dependency:cargo-commands');
var dependencies = ['tauri-bundler'];
function manageDependencies(managementType) {
    return __awaiter(this, void 0, void 0, function () {
        var installedDeps, updatedDeps, _i, dependencies_1, dependency, currentVersion, latestVersion, inquired, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    _a.label = 1;
                case 1:
                    if (!(_i < dependencies_1.length)) return [3 /*break*/, 9];
                    dependency = dependencies_1[_i];
                    currentVersion = get_script_version_1.default('cargo', [dependency]);
                    if (!(currentVersion === null)) return [3 /*break*/, 2];
                    log("Installing " + dependency + "...");
                    cross_spawn_1.sync('cargo', ['install', dependency]);
                    installedDeps.push(dependency);
                    return [3 /*break*/, 8];
                case 2:
                    if (!(managementType === types_1.ManagementType.Update)) return [3 /*break*/, 7];
                    return [4 /*yield*/, util_1.getCrateLatestVersion(dependency)];
                case 3:
                    latestVersion = _a.sent();
                    if (!util_1.semverLt(currentVersion, latestVersion)) return [3 /*break*/, 5];
                ...
                case 4:
                    ...
                    // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access
                    if (inquired.answer) {
                        cross_spawn_1.sync('cargo', ['install', dependency, '--force']);
...
/*! CommonJS bailout: this is used directly at 45:23-27 */
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
            ...
            switch (_a.label) {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    if (!(currentVersion === undefined)) return [3 /*break*/, 2];
                                    log("Installing " + dependency + "...");
                                    return [4 /*yield*/, util_1.getCrateLatestVersion(dependency)
                ...
                case 4:
                    ...
                    if (updatedDeps.length) {
                        ...
                        spawn_1.spawnSync('cargo', __spreadArrays([
                            'update',
                            '--aggressive'
                        ], updatedDeps.reduce(function (initialValue, dep) { return __spreadArrays(initialValue, ['-p', dep]); }, [])), app_paths_1.tauriDir);
                    }
                    result.set(types_1.ManagementType.Install, installedDeps);
                    result.set(types_1.ManagementType.Update, updatedDeps);
                    return [2 /*return*/, result];
...
/*! CommonJS bailout: this is used directly at 57:23-27 */
...
var cargoCommands = __importStar(__webpack_require__(/*! ./cargo-commands */ "./src/api/dependency-manager/cargo-commands.ts"));
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        rust.install();
                        return [4 /*yield*/, cargoCommands.install()];
                    case 1:
                        _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        rust.update();
                        return [4 /*yield*/, cargoCommands.update()];
                    case 1:
                        _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    installedDeps = [];
                    updatedDeps = [];
                    if (!fs_1.existsSync(app_paths_1.resolve.app('package.json'))) return [3 /*break*/, 9];
                    _i = 0, dependencies_1 = dependencies;
                    _a.label = 1;
                case 1:
                    if (!(_i < dependencies_1.length)) return [3 /*break*/, 9];
                ...
                case 2:
                    ...
                    if (!(currentVersion === null)) return [3 /*break*/, 3];
                    log("Installing " + dependency + "...");
...
/*!*********************************************!*\
  ...
  \*********************************************/
/*! flagged exports */
/*! export ManagementType [provided] [no usage info] [missing usage info prevents renaming] */
...
/******/ 	return __webpack_require__("./src/api/dependency-manager/index.ts");
/******/ })()
;
});
