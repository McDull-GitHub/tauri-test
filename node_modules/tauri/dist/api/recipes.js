...
/*!**********************************!*\
  ...
  \**********************************/
/*! flagged exports */
/*! export __esModule [provided] [maybe used in api/recipes (runtime-defined)] [usage prevents renaming] */
/*! export allRecipes [provided] [maybe used in api/recipes (runtime-defined)] [usage prevents renaming] */
/*! export recipeByDescriptiveName [provided] [maybe used in api/recipes (runtime-defined)] [usage prevents renaming] */
/*! export recipeByShortName [provided] [maybe used in api/recipes (runtime-defined)] [usage prevents renaming] */
/*! export recipeDescriptiveNames [provided] [maybe used in api/recipes (runtime-defined)] [usage prevents renaming] */
/*! export recipeNames [provided] [maybe used in api/recipes (runtime-defined)] [usage prevents renaming] */
/*! export recipeShortNames [provided] [maybe used in api/recipes (runtime-defined)] [usage prevents renaming] */
/*! other exports [not provided] [maybe used in api/recipes (runtime-defined)] */
...
exports.recipeByShortName = function (name) {
    return lodash_1.find(exports.allRecipes, function (r) { return r.shortName === name; });
};
exports.recipeByDescriptiveName = function (name) {
